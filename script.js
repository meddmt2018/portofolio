...
const defaultData = {
  profile: {
    ...
    aboutText2: "Dari sana, saya membawa kebiasaan belajar mandiri ke dunia teknologi. Sekarang saya fokus mengembangkan kemampuan di bidang web development, menyatukan logika teknis dengan cara berpikir yang terstruktur.",
    aboutText3: "Saya percaya bahwa teknologi paling bermakna ketika ia benar-benar bermanfaat bagi orang lain. Bukan sekadar bisa dibuat, tapi bisa dirasakan manfaatnya. Prinsip itu yang mendorong saya untuk tidak hanya belajar cara membangun sesuatu, tapi memahami mengapa ia harus ada.",
